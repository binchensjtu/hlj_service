...
$where = array("admin_payed"=>0, "state"=>"WAIT_BUYER_CONFIRM_GOODS");
    ...
    <div data-role="header" data-position="fixed">
        <div data-role="navbar">
            <ul id="mani">
                ...
                <li><a href="#" class="ui-btn-active" data-ajax='false'>待打款</a></li>
                ...
                if($out[$i]['tid'] != '') {
                    ...
                    <div class="ui-grid-b">
                        ...
                        <div class="ui-block-c ui-block-mani">
                            <button class='mani-pay' id='<?php echo $out[$i]['tid'] ?>'>确定打款</button>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.mani-pay').click(function(){
                var r = confirm("是否已经给买手打款？");
                tid = $(this).attr('id');
                if(r) {
                    $.ajax({
                        url: "./admin_make_pay.php",
                        type: "POST",
                        dataType: 'jsonp',
                        jsonp: 'callback',
                        data: 'tid='+ tid,
