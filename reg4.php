...
require_once('./push/push_hlj.php');
...
$params = array(
    ...
    'desc' => "<p>商品信息：".$_SESSION['item_info']."</p><br><p>备注：".$_SESSION['ps']."</p><br>"."<div class='picdes'><p><b style='color: red;'>近期微信支付不稳定，如果不能成功使用“微信支付”，建议选择“其他支付方式-信用卡/储蓄卡”进行付款。</b><br><b>代购说明：</b><br />1、代购商品若非运输破损导致商品无法正常使用，不提供退换。<br />2、代购到货时间通常为付款后2-4周，不排除物流公司原因造成的延迟到货情况，请亲们理解哦！</p></div>".
...
pushMessageToFangFang("buy");
pushMessageToHuanHuan("buy");
